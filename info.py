...
URL = "https://sb-filter.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://sb-filter.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://sb-filter.onrender.com/".format(FQDN)
else:
    URL = "https://sb-filter.onrender.com/".format(FQDN)
